...
int APIENTRY WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	if (Gui::CreateDevice()) {
		...
		//io.Fonts->AddFontFromFileTTF("../data/Fonts/Ruda-Bold.ttf", 15);
		...
		while (Gui::Instance) {
			...
			ImGui::SetNextWindowSize(ImVec2(650 + 100, 415 + 130), ImGuiCond_::ImGuiCond_Once);
			...
			if (ImGui::Begin("MultiBot V.1", &Gui::Instance, window_flags)) {
				...
				if (ImGui::BeginTabItem("Main")) {
					...
					ImGui::BeginChild("ls", ImVec2(200, 347 + 100), false);
					static float availx = ImGui::GetContentRegionAvail().x;
					
					if (ImGui::BeginListBox("##lbls", ImVec2(availx, 380.f))) {
					...
					ImGui::BeginChild("rs", ImVec2(420 + 100, 347 + 100), true);
					if (bot){
						...
						if (ImGui::BeginTabItem("Auto")) {
							...
							/*
							if (ImGui::BeginTabItem("Pabrik")) {
								ImGui::BeginChild("ap", ImVec2(0, 0));
								ImGui::TextUnformatted("kosong wkwk coming soon");
								ImGui::EndChild();
								ImGui::EndTabItem();
							}
							*/
						...
						ImGui::TextUnformatted("Select a bot");
					}
